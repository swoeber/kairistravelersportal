...
// Styles
import styles from './Styles/TextablesScreenThreeStyle'

class TextablesScreenThree extends React.PureComponent {
  /* ***********************************************************
  * STEP 1
...
export default connect(mapStateToProps, mapDispatchToProps)(TextablesScreenThree)
